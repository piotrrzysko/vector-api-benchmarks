...
/*
    This is an implementation of a simdjson-java's (https://github.com/simdjson/simdjson-java) component
    called 'structural indexer'.

    The StructuralIndexerBenchmark shows that the allocation rate for this implementation is relatively high
    (I run the benchmark on my desktop with 256-bit registers and temurin-21.0.1):
    ...
    Based on the async-profiler output (results/original-alloc.html) most of the allocations are caused by ByteVector::fromArray.
 */
public class OriginalStructuralIndexer {
    ...
    public OriginalStructuralIndexer(BitIndexes bitIndexes) {
    ...
    private void step(ByteVector chunk0, ByteVector chunk1, int blockIndex) {
        // string scanning
